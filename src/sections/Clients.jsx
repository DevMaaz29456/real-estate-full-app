...
const Clients = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "ligth bg-transparent"}`}>
      <section
        id="testimonials"
      ...
      >
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          >
            what our clients<br></br>says about us
          </h1>
        </div>
        <div
          id="clients-box"
        ...
        >
          {client.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-fyll"
            >
