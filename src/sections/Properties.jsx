...
import {
  ...
  FaPlus,
  FaMapMarkerAlt,
  FaVideo, // Corrected spelling
  FaCamera,
  FaHeart, // Corrected spelling
} from "react-icons/fa";
...
const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        id="properties"
        className="lg:w-[90%] m-auto lg:px-20 py-20 w-full flex flex-col justify-center items-start gap-10"
      >
        ...
        >
          {property.map((item, index) => (
            ...
            >
              <div
                id="image-box"
                className="bg-cover bg-center h-[250px] rounded-xl p-4 flex
              ...
              <div className="px-6 py-3 flex flex-col items-start justify-center gap-2 w-full">
                ...
                >
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <h1 className="dar:text-white">{item.bath}</h1>
                  </div>
                  <div className="flex justify-center items-center gap-2">
                    <FaBed className="size-5 text-red-400" />
                    <h1 className="dar:text-white">{item.bed}</h1>
                  </div>
                  <div className="flex justify-center items-center gap-2">
                    <MdSpaceDashboard className="size-5 text-red-400" />
                    <h1 className="dar:text-white">{item.area}</h1>
                  </div>
                </div>
