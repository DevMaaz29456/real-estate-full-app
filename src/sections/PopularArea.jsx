      ...
      >
        ...
        >
          <div>
            ...
            >
              Explore most <br /> Popular Area
            </h1>
          </div>
          <div className="grid lg:grid-cols-3 cols-span-2 grid-cols-1 justify-center items-center gap-6">
            <div
              data-aos="zoom-in"
              data-aos-delay="400"
              style={{ backgroundImage: `url(${area1})` }}
              className="h-[400px] lg:w-[90%] w-full bg-cover bg-center rounded-xl"
            ></div>
            <div
              data-aos="zoom-in"
              data-aos-delay="400"
