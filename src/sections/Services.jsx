  ...
  return (
    ...
    >
      <section
        ...
        } lg:w-[95%] w-full h-fit m-auto rounded-xl flex flex-col justify-center items-start lg:px-6 py-20 gap-10`}
      >
        ...
        >
          {service.map((item, index) => (
            ...
            >
              <div className="p-6 ronded-full bg-red-200">
              ...
              <p className="text-lg text-slate-700 dar:text-white">
                {item.desc}
              </p>
              <button className="border-b-2 border-red-600 text-red-600 font-semiboldp-0 dark:text-white">
                Read More
              </button>
            </div>
          ))}
