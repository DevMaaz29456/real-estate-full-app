...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* mobile menu icons strarts from here */}
      <div
      ...
      >
        <div>
          {isMenuOpen ? (
            <FaXmark className="text-black bg:text-white text-2xl cursor-pointer" />
          ) : (
            <FaBars className="text-black bg:text-white text-2xl cursor-pointer" />
          )}
        </div>
      </div>
      ...
      <div
        ...
        } w-full h-fit bg-slate-800 p-4 absolute top-[80px] left-o `}
        onClick={closeMenu}
      >
