...
import { useDarkMode } from "./DarkModeContext"; // Correct import
import {
  FaFacebookF,
  FaInstagram,
  FaTwitter,
...
const Footer = () => {
  const { darkMode, toggleDarkMode } = useDarkMode(); // Access both darkMode and toggleDarkMode here
  ...
  return (
    <>
      ...
      lg:px-20 px-10 py-20 grid lg:grid-cols-3 grid-cols-1 justify-center items-start lg:gap-20 gap-10`}
      >
        <div className="flex flex-col justify-center items-start gap-5">
          <h1 className="text-white text-2xl font-semibold">About Us</h1>
          <p className="text-slate-200 text-justify">
            Need help or have questions? Reach out to us through the contact
            form. We're here to assist you and will respond as quickly as
          ...
          <h1 className="text-white mt-8">
            Copyright Realestate, All Rights Reserved
          </h1>
        </div>
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">We will be in touch</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaMobile className="text-white size-5" />
            <p className="text-slate-200">+92 342-1179168</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200">+67-21378123817</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <IoMdMail className="text-white size-5" />
            <p className="text-slate-200">maazkhan29456@gmail.com</p>
          </div>
        </div>
        <div className="flex flex-col items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">$ 682.89</p>
            </div>
          </div>
          <div className="flex justify-center items-center gap-4">
            <img
              src={prop8}
              alt="Smart view from beach"
              className="w-[120px] rounded-lg transform hover:scale-110 cursor-pointer transition-transform duration-300"
            />
            <div>
              <h1 className="text-lg text-white">Smart view from beach</h1>
              <p className="text-slate-400">$ 869.89</p>
            </div>
          </div>
        </div>
      </footer>
